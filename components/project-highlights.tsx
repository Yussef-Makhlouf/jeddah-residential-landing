      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-2 gap-4 md:gap-6 lg:gap-8 mb-12">
          {highlights.map((highlight, index) => (
            <div key={index} className="flex items-center justify-center gap-3 md:gap-4 bg-[#f5f3f0] rounded-2xl py-4 md:py-6 px-2 md:px-4">
              <div className="flex-shrink-0 flex items-center justify-center bg-white rounded-full w-12 md:w-16 h-12 md:h-16 border border-[#e5e1dc]">
