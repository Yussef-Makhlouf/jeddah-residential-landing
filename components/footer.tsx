...
import WebsiteDataService, { ProjectInfo, SocialMedia } from "@/lib/website-data"
...
export function Footer() {
  ...
  useEffect(() => {
    ...
    setProjectInfo(WebsiteDataService.getProjectInfo())
    setSocialMedia(WebsiteDataService.getSocialMedia())
  }, [])
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            />
            <div>
              <h3 className="text-xl font-bold">{projectData?.name || "مشروع راف 25"}</h3>
              <p className="text-sm text-gray-200"> رقم الترخيص: {projectInfo.licenseNumber}</p>
              <p className="text-sm text-gray-200"> الرقم الموحد: {projectInfo.unifiedNumber}</p>
            </div>
          </div>
              ...
              {socialMedia.map((social, index) => (
                ...
                >
                  ...
                  {social.platform === "Snapchat" && (
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#540f6b" className="w-6 h-6">
          ...
          <div className="text-center md:text-right" dir="ltr">
            <p className="text-sm text-gray-200">
              &copy; 2025 {projectInfo.name}. جميع الحقوق محفوظة.
            </p>
          </div>
        </div>
      </div>
