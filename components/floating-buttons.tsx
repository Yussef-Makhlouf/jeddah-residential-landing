  ...
  return (
    <div className="fixed bottom-6 left-6 z-40 flex flex-col gap-3">
      ...
      <Button
        ...
        className="bg-[#25D366] hover:bg-[#128C7E] border-2 border-white  text-white rounded-full w-14 h-14 p-0 shadow-elegant-lg hover:shadow-xl transition-all duration-300 hover:transform hover:-translate-y-1"
